            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url() ?>index.php/welcome/institution">Register as an
                                institution/Institutional profile</a></li>
                        <li><a href="<?= base_url() ?>index.php/welcome/teacher">Register as a teacher/Teachers
                                Profile</a></li>
                    </ul>
                </li>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="form-group"><label>Email</label> <input placeholder="Email"
                                                                                            class="form-control"
                                                                                            type="Email"></div>


                                        <div class="form-group"><label>Password</label> <input placeholder="Password"
                                                                                               class="form-control"
                                                                                               type="password"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <hr>
                                            <center>
                                                </label><a href="#" id="reg_link" onclick="modle_pop();"
                                                           data-toggle="modal">Create new account</a></lable>
                                            </center>
